...
<body id="wrap">
	...
	<div class="sjsc-title1" style="position:fixed;z-index：999">
		<h3 class="sjsc-t1l f-l">
			<a href="JavaScript:window.location.href=document.referrer"><span class="le"><img
					src="images/back.png" alt=""
					style="width:20px;height: 20px;padding-top: 11px;padding-left: 5px" /></span></a>
		</h3>
		<!-- 
	...
	<c:forEach items="${list}" var="list">
		...
		<input type="hidden" value="${list.goods_num}" id="goods_num"}>
		...
		<div class="spxq-info1">
			<ul class="spxq-ul1">
				<li>
					...
					<div>
						<p class="spxq-p1" style="font-size: 12px;line-height:35px;">
							<span>${list.goods_spe}</span>
						</p>
						<p class="spxq-p1">
							<font style="font-size: 9px;color: #f60">￥</font><span
								style="color: #f60">${list.goods_price}</span>
						</p>
		...
		<div class="spxq-info2">
			...
			<div class="spxq-box">
				<div class="spxq-k spxq-k1">${list.goods_detail}</div>
			</div>
		</div>
	</c:forEach>
	<div class="spxq-info3">
		...
		<a href="cartList.html" class="if3-aa f-l"><img
			src="images/cart.png" /><span style="position:fixed;color: #ff3c00"
			id="cart_num">${cart_num }</span></a>
